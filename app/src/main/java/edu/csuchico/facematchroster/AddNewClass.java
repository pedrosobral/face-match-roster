...
import edu.csuchico.facematchroster.model.Class;
    ...
    private class saveStudentToCognitoTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                aClass.setInstructorName(mInstructorName.getText().toString());
                aClass.setTimestamp(System.currentTimeMillis());
                aClass.setInstructorEmail(mInstructorEmail.getText().toString());
                aClass.setSchool(mSchool.getText().toString());
                aClass.setClassName(mClassName.getText().toString());
                aClass.setClassCode(mClassCode.getText().toString());
                aClass.setClassSection(mClassSection.getText().toString());
                aClass.setSemester(mSemester.getText().toString());
